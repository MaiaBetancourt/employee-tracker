...
VALUE ("Aster", "Florez", 1, 1);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Mike", "Meredith", 2, 1);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Cristina", "Padron", 2, 1);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Luis", "Nunes", 3, 2);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Kaylee", "Medina", 4, 2);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Luis", "Betancourt", 5, 2);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Beatrice", "Santana", 6, 3);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Margarita", "Ramirez", 7, 3);
INSERT INTO employee (first_name, last_name, role_id, manager_id)
VALUE ("Raul", "Betancourt", 7, 3);